...
// CircleOnPlane.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCircleOnPlaneApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCircleOnPlaneApp

CCircleOnPlaneApp::CCircleOnPlaneApp()
{
...
// Единственный объект CCircleOnPlaneApp

CCircleOnPlaneApp theApp;


// инициализация CCircleOnPlaneApp

BOOL CCircleOnPlaneApp::InitInstance()
{
